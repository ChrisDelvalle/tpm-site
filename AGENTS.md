...
references. New component-controlled images should use Astro image tooling where
possible, stable dimensions or aspect ratios, responsive sizes, useful alt text,
and deliberate loading priority. Do not add oversized uploads or meaningful
