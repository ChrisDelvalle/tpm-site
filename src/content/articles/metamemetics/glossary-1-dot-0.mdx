...
import articleImage01 from "../../../assets/shared/2x2-meme-table.png";
import articleImage02 from "../../../assets/articles/glossary-1-dot-0/phylomemetic-tree-lamarckian.png";
...
<ul class="glossary-toc">
  <li>
    <a href="#Autist">Autist</a>
  </li>
  <li>
    <a href="#IronicMemes">Ironic Memes</a>
  </li>
  <li>
    <a href="#Ironist">Ironist</a>
  </li>
  <li>
    <a href="#MetaIronicMemes">Meta-Ironic Memes</a>
  </li>
  <li>
    <a href="#Mutation">Mutation</a>
  </li>
  <li>
    <a href="#NarratologicalSubversion">Narratological Subversion</a>
  </li>
  <li>
    <a href="#NeoTraditionalistMemes">Neo-Traditionalist Memes</a>
  </li>
  <li>
    <a href="#Normalization">Normalization</a>
  </li>
  <li>
    <a href="#Normie">Normie</a>
  </li>
  <li>
    <a href="#Normification">Normification</a>
  </li>
  <li>
    <a href="#PostIronicMemes">Post-Ironic Memes</a>
  </li>
  <li>
    <a href="#PreIronicMemes">Pre-Ironic Memes</a>
  </li>
  <li>
    <a href="#ProtoIronicMemes">Proto-Ironic Memes</a>
  </li>
  <li>
    <a href="#SimplicityComplexity">Simplicity/Complexity</a>
  </li>
  <li>
    <a href="#StructuralSubversion">Structural Subversion</a>
  </li>
  <li>
    <a href="#StylisticSubversion">Stylistic Subversion</a>
  </li>
  <li>
    <a href="#ThePhylomemeticTree">The Phylomemetic Tree</a>
  </li>
  <li>
    <a href="#TheQuadrantofIronicMemes">The Quadrant of Ironic Memes</a>
  </li>
  <li>
    <a href="#TraditionalistMemes">Traditionalist Memes</a>
  </li>
</ul>
...
<Image src={articleImage02} alt="" class="glossary-image" />
...
<Image src={articleImage01} alt="" class="glossary-image" />
