...
Inferential criticism is an art-critical methodology introduced by Baxandall (1985)[^cite-baxandall-m-1985-patterns-of-intention]. The purpose of art criticism, according to inferential criticism, is to explain the design of the artwork in light of the problems addressed by the artist through the work. Although Baxandall explicitly denies that he is addressing the question "What is art?" (Baxandall, 1985, viii)[^cite-baxandall-m-1985-patterns-of-intention], his account of inferential criticism is nonetheless based on his ontology of artworks as embodied solutions to particular aesthetic problems.

Wollheim's (1968)[^cite-wollheim-r-1968-art-and-its-objects] attempt at answering the same question, in _Art and Its Objects_, and his own theory of "Criticism as Retrieval" (Wollheim, 1980)[^cite-wollheim-r-1980-criticism-as-retrieval], based on his ontology of art as type-token pairs, provide an ideal point of comparison. Wollheim characterises inference as diametrically opposed to retrieval, and criticises it on methodological grounds as well as purposive grounds (1984)[^cite-wollheim-r-1984-art-interpretation-and-the-creative]. Wollheim's attack on inference is devastating in that it threatens to render it either tautological or totally detached from truthfulness.

Despite Wollheim's strong opposition to inference (Wollheim, 1984)[^cite-wollheim-r-1984-art-interpretation-and-the-creative], I find that Baxandall's sense of inference escapes the criticisms, and instead a powerful synthesis of the two methodologies is possible. If art is problem solving, then explaining the solutions would be perhaps the most efficient means of encouraging further production of art. Inferential criticism promises to be the most productive method of art criticism.

"[Criticism] is the process of coming to understand a particular work of art." (Wollheim, 1980, p. 185)[^cite-wollheim-r-1980-criticism-as-retrieval]. By this, Wollheim means specifically to reject what he calls the Croce-Collingwood thesis, which claims that criticism is the process of reproducing the internal state of the artist such that the critic's readers may also share the correct experience (Wollheim, 1968, p. 56)[^cite-wollheim-r-1968-art-and-its-objects]. On this point, both inferentialists and retrievalists agree.
...
```tpm-bibtex
@misc{baxandall-m-1985-patterns-of-intention,
  citation = {Baxandall, M. (1985). Patterns of Intention. Yale University Press.},
  author = {Baxandall, M.},
  title = {Patterns of Intention},
  year = {1985},
}

@misc{haack-r-1982-wittgenstein-s-pragmatism,
  citation = {Haack, R. (1982). Wittgenstein's Pragmatism.},
  author = {Haack, R.},
  title = {Wittgenstein's Pragmatism.},
  year = {1982},
}

@misc{hull-d-l-1978-a-matter-of-individuality,
  citation = {Hull, D.L. (1978). A Matter of Individuality. Philosophy of Science, 45(3), 335-360.},
  author = {Hull, D.L.},
  title = {A Matter of Individuality},
  year = {1978},
}

@misc{lewens-t-2004-organisms-and-artifacts-design-in,
  citation = {Lewens, T. (2004). Organisms and Artifacts: Design In Nature and Elsewhere. The MIT Press.},
  author = {Lewens, T.},
  title = {Organisms and Artifacts: Design In Nature and Elsewhere},
  year = {2004},
}

@misc{wollheim-r-1968-art-and-its-objects,
  citation = {Wollheim, R. (1968). Art and Its Objects. New York: Peregrine Books.},
  author = {Wollheim, R.},
  title = {Art and Its Objects},
  year = {1968},
}

@misc{wollheim-r-1980-criticism-as-retrieval,
  citation = {Wollheim, R. (1980). "Criticism as retrieval". Art and Its Objects (2nd ed.). Cambridge University Press.},
  author = {Wollheim, R.},
  title = {Criticism as retrieval"},
  year = {1980},
}

@misc{wollheim-r-1984-art-interpretation-and-the-creative,
  citation = {Wollheim, R. (1984). Art, Interpretation, and the Creative Process. New Literary History. Vol. 15, No. 2, Interrelation of Interpretation and Creation, 241-253.},
  author = {Wollheim, R.},
