...
- Raw HTML links: 20
- Markdown links inventoried as prose links: 369
...
The 369 Markdown links and 344 raw URL occurrences are intentionally not treated
