...
| --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| Content model               | Loading, validating, normalizing, sorting, and aggregating publishable entries and editorial metadata.                                                            | `announcements`, `archive`, `article-list`, `article-view`, `authors`, `collections`, `content`, `content-schemas`, `home`, `publishable`, `tags`   |
...
| Article rendering           | Prose-adjacent article view helpers such as image policy, title fitting, and table-of-contents data.                                                              | `article-image-policy`, `article-list-title-fit`, `article-toc`                                                                                     |
