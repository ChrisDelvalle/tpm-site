...
Source: `src/components/articles/MoreInCategoryBlock.astro`
...
It composes local components: `../../lib/article-list`, `../ui/TextLink`, `./ArticleList`. Parent blocks should pass normalized props and slots rather than asking this component to fetch global content directly.
