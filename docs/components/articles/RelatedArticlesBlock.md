...
Source: `src/components/articles/RelatedArticlesBlock.astro`
...
It composes local components: `../../lib/article-list`, `./ArticleList`. Parent blocks should pass normalized props and slots rather than asking this component to fetch global content directly.
