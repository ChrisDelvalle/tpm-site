...
Source: `src/components/navigation/CategorySidebar.astro`

## Purpose

`CategorySidebar` provides persistent desktop category discovery without obscuring content during scroll
...
- The sticky top offset must stay synchronized with the header height token; invariant tests should prove the sidebar heading never disappears beneath the header while scrolling.
