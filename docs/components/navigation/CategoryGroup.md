...
Source: `src/components/navigation/CategoryGroup.astro`

## Purpose

`CategoryGroup` serves as a navigation component for site discovery, wayfinding, search, category browsing, or support actions.
...
It composes local components: `../../lib/navigation`, `./SectionNavItem`. It must remain interchangeable between header, mobile menu, sidebar, and footer contexts where the public contract allows it.
