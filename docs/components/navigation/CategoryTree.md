...
Source: `src/components/navigation/CategoryTree.astro`

## Purpose

`CategoryTree` serves as a navigation component for site discovery, wayfinding, search, category browsing, or support actions.
...
It composes local components: `../../lib/navigation`, `./CategoryGroup`. It must remain interchangeable between header, mobile menu, sidebar, and footer contexts where the public contract allows it.
