...
Source: `src/components/ui/TextLink.astro`

## Purpose

`TextLink` serves as a low-level UI primitive with no article, route, or content-collection knowledge.

## Public Contract

- `href: string`
- `tone?: "muted" | "neutral" | "primary"`
- `variant?: "inline" | "nav" | "subtle"`
