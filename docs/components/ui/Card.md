...
Source: `src/components/ui/Card.astro`

## Purpose

`Card` serves as a low-level UI primitive with no article, route, or content-collection knowledge.

## Public Contract

- `as?: "article" | "div" | "li" | "section"`
- `padding?: "none" | "sm" | "md" | "lg"`
- `tone?: "muted" | "plain" | "surface"`
- `variant?: "bordered" | "elevated" | "plain"`
