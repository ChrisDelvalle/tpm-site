...
`SiteShell` serves as a layout component that owns document regions, page framing, or persistent chrome.
...
It composes local components: `../../lib/content`, `../../lib/navigation`, `./MainFrame`, `./SiteFooter`, `./SiteHeader`. It defines region relationships for children; children should not patch its spacing or stacking from outside.
