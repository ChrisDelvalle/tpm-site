...
Source: `src/components/blocks/HomeAnnouncementBlock.astro`

## Purpose

`HomeAnnouncementBlock` serves as a page-level block that represents a reusable editorial section.
...
It composes local components: `../pages/PageProse`. Parent blocks should pass normalized props and slots rather than asking this component to fetch global content directly.
