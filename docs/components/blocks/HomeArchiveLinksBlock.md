# Home Archive Links Block

Source: `src/components/blocks/HomeArchiveLinksBlock.astro`

## Purpose

`HomeArchiveLinksBlock` serves as a page-level block that represents a reusable editorial section.
...
It composes local components: `../ui/LinkButton`, `../ui/TextLink`. Parent blocks should pass normalized props and slots rather than asking this component to fetch global content directly.
