# Home Featured Articles Block

Source: `src/components/blocks/HomeFeaturedArticlesBlock.astro`

## Purpose

`HomeFeaturedArticlesBlock` serves as a page-level block that represents a reusable editorial section.
