...
Source: `src/components/article/ArticleProse.astro`
...
It composes local components: `../articles/ArticleProse`. Parent blocks should pass normalized props and slots rather than asking this component to fetch global content directly.
