...
Source: `src/components/article/HoverImageLink.astro`

## Purpose

`HoverImageLink` serves as a legacy article-specific compatibility component kept only where older MDX still imports it.
...
It composes local components: `../articles/HoverImageLink`. Parent blocks should pass normalized props and slots rather than asking this component to fetch global content directly.
