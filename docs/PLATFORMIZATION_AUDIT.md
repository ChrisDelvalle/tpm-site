...
| Home page            | Homepage data now comes mostly from publishable entries and collections, but hero images and collection IDs still need config/content ownership. | Keep the homepage as a small typed recipe: configured collection IDs and limits, editor-owned collections, and page-owned hero images. | High   |
